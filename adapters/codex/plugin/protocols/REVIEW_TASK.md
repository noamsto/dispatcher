...
Steps 1–3 are the pi path as written. On another engine with panes they are the additive pass: assign the `reviewer` pane once (step 1) and merge its findings into your own set; run step 2's refuter panes over that merged set alongside your native refuters; release both (step 3).
