...
- pi leans: DeepSeek and other third-family models through OpenRouter (work
  profile) or opencode Zen (personal profile), when an independent
  non-Claude/non-OpenAI perspective is useful. It is available in every profile.
