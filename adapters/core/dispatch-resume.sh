...
# does not match this script's baked revision (#184). See dispatch.sh's copy of
# this helper for the full contract: a substituted marker compares against the
# dir's committed PROTOCOL_REV (generated by scripts/gen-adapters.sh); a stale
# dir is refused before any scaffolding; a raw checkout script skips with a
# one-line warning.
_check_protocol_rev() {
